...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  ${tradutor.texto1[1]} 𝐗𝐢𝐦𝐞
  ${tradutor.texto1[2]} +5492645130919
  ...
  const Message = {
    document: { url: `https://www.instagram.com/𝙖𝙡𝙚_𝟎𝟓𝟔𝟕/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/𝙖𝙡𝙚_𝟎𝟓𝟔𝟕/",
        mediaType: 2,
        previewType: "pdf",
        title: "𝐗𝐢𝐦𝐞",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/𝙖𝙡𝙚_𝟎𝟓𝟔𝟕/",
      },
    },
    caption: info,
    footer: wm,
