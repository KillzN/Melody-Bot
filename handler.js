...
export async function handler(chatUpdate) {
  ...
  /* Creditos a Otosaka (https://wa.me/5492645130919) */
    ...
    case 'remove':
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          let pp = 'https://raw.githubusercontent.com/KillzN/Meloy-Bot/master/src/avatar_contact.png';
          try {
